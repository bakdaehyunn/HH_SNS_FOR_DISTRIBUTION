...
public interface FollowDAO {
	...
	List<UserInfoVO> selectFollowingList(String userId); // 팔로워 리스트 불러오기
	List<UserInfoVO> selectFollowerListPaging(String userId,PageCriteria criteria);// 페이징 처리된 팔로잉 리스트 불러오기
	List<UserInfoVO> selectFollowerList(String userId);// 팔로잉 리스트 불러오기
